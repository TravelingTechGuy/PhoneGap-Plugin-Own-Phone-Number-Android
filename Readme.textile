...
# *Create the plugin* - add a class to your Java project 
## The class extends _Plugin_ (see "MyPhoneGapPlugin.java":https://github.com/TravelingTechGuy/My-Phone-Number-Plugin/blob/master/src/com/travelingtechguy/myphonenumberplugin/MyPhoneNumberPlugin.java) 
